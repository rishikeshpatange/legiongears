          ...
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                ...
                {/* Add buttons for color and dropdown for size */}
              </div>
              <div className="flex">
              ...
              {service === false && (
                <div className="text-red-700 text-sm mt-3">Sorry! We do not deliver to this pincode yet.</div>
              )}
              {service === true && (
                <div className="text-green-700 text-sm mt-3">We do deliver to this pincode.</div>
              )}
            </div>
          </div>
        </div>
...
export async function getServerSideProps(context) {
  ...
  // Find product from the productData array
  ...
  // Assuming variants are stored within the product data in the JSON file
  const variants = product.variants || {};

  return {
    props: { product, variants }, // Pass product and variants as props
  };
}
